...
class Video {
  ...
  private function render_vimeo_player() {
    echo '<iframe  id="myiFrame" src="http://player.vimeo.com/video/'. $this->get_vimeo_ref_from_url() .'?autoplay='. $this->autoplay .'&title=0&byline=0&portrait=0" frameborder="0"   width="640" height="338"  webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
  }
